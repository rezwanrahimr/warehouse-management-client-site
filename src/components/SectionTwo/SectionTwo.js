      ...
      <div className="row">
        <div className="col-md-6 col-12 text-center  d-flex align-items-center">
          <div>
            ...
            <h6>
              Air Conditioner Integrated With Intelligent Inverter Technology
              Save Electricity up to 70%.
            </h6>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-md-6 col-12 text-center  d-flex align-items-center">
          <div>
            ...
            <h1>BEGINS HERE</h1>
            <h6>
              The Primo ZX4 is everthing you wnat in a perfect smartphone,large
              FHD+Display,Penta Al Cameras,Gaming Centric Processor,amazing RAM
              and ROM,awestruck selfie camera and much more.
            </h6>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-md-6 col-12 text-center  d-flex align-items-center">
          <div>
            ...
            <h6>
              Multifunctrional & energy efficient Walton Washing Machine
              surprise you with the finest washing performance. Now make your
              washing innovatively convenient.
            </h6>
          </div>
        </div>
        <div className="col-md-6 col-12">
      ...
      <div className="row">
        ...
        <div className="col-md-5 col-12 text-center  d-flex align-items-center">
          <div>
            ...
            <h6>
              Walton Microwave Oven Comes up with Multi-functional Authomatic
              Cooking Menus and several Power Level Setting that help to cook
              enything in no time!
            </h6>
          </div>
        </div>
